/*
	$Id: eph_priv.h,v 2.7 1999/01/17 09:50:55 crosser Exp crosser $
*/
...
/* pjt: Similar to ATLTRACE */
#ifdef _DEBUG
void EphTrace(const char* lpszFormat, ...);
#define EPHTRACE EphTrace
#else // !DEBUG
__inline void EphTrace(const char* lpszFormat, ...){}
#define EPHTRACE 1 ? (void)0 : EphTrace
#endif
